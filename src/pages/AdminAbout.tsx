                        ...
                        <Card key={member.id}>
                          <CardContent className="p-4 flex items-center justify-between">
                            ...
                            <div className="flex gap-1">
                              <Button variant="ghost" size="icon" onClick={() => { setEditingMember(member); setMemberDialogOpen(true); }}>
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <Dialog open={contentDialogOpen} onOpenChange={setContentDialogOpen}>
              <DialogTrigger asChild>
                <Button variant="outline" onClick={() => setEditingContent({ page_key: 'about', display_order: 0 })}>
          ...
          {loading ? <Skeleton className="h-32 w-full" /> : (
            <div className="grid gap-3">
              {contentBlocks.map(block => (
                <Card key={block.id}>
                  <CardContent className="p-4 flex items-center justify-between">
                    ...
                    <div className="flex gap-1">
                      <Button variant="ghost" size="icon" onClick={() => { setEditingContent(block); setContentDialogOpen(true); }}>
                        <Edit2 className="w-4 h-4" />
                      </Button>
              ...
              {contentBlocks.length === 0 && <p className="text-muted-foreground text-center py-8">No content blocks yet.</p>}
            </div>
          )}
        </div>
      </main>
